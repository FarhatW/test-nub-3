...
namespace jce.BusinessLayer.Helpers
{
    ...
    {
        public static Dictionary<string, string> GetProperties(Type obj)
        {
            ...
            foreach (var propertyInfo in props)
            {
                ...
                string ok = ColumnsHelper.TranslateGoogle(propertyInfo.Name, "en", "fr");
       

                keyValuePair.Add(propertyInfo.Name.ToString(), ok);
            }
